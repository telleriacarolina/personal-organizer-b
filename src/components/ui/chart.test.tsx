...
describe('ChartContainer', () => {
  it('includes Recharts 3-specific theme selectors', () => {
    ...
    expect(className).toContain('[&_.recharts-cartesian-axis-tick-value]:fill-muted-foreground');
    expect(className).toContain("[&_.recharts-cross.recharts-tooltip-cursor[stroke='#ccc']]:stroke-border");
    expect(className).toContain("[&_.recharts-rectangle.recharts-tooltip-cursor[fill='#ccc']]:fill-muted");
